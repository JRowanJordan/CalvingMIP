...
% 
% 
nccreate(ExpName,'lithkA','Dimensions',{'Profile A' numel(lithkA)})
nccreate(ExpName,'sA','Dimensions',{'Profile A' numel(lithkA)})
nccreate(ExpName,'xvelmeanA','Dimensions',{'Profile A' numel(lithkA)},'FillValue',nan)
nccreate(ExpName,'yvelmeanA','Dimensions',{'Profile A' numel(lithkA)},'FillValue',nan)
nccreate(ExpName,'maskA','Dimensions',{'Profile A' numel(lithkA)})

nccreate(ExpName,'lithkB','Dimensions',{'Profile B' numel(lithkB)},'FillValue',nan)
nccreate(ExpName,'sB','Dimensions',{'Profile B' numel(lithkB)})
nccreate(ExpName,'xvelmeanB','Dimensions',{'Profile B' numel(lithkB)},'FillValue',nan)
nccreate(ExpName,'yvelmeanB','Dimensions',{'Profile B' numel(lithkB)},'FillValue',nan)
nccreate(ExpName,'maskB','Dimensions',{'Profile B' numel(lithkB)})

nccreate(ExpName,'lithkC','Dimensions',{'Profile C' numel(lithkC)},'FillValue',nan)
nccreate(ExpName,'sC','Dimensions',{'Profile C' numel(lithkC)})
nccreate(ExpName,'xvelmeanC','Dimensions',{'Profile C' numel(lithkC)},'FillValue',nan)
nccreate(ExpName,'yvelmeanC','Dimensions',{'Profile C' numel(lithkC)},'FillValue',nan)
nccreate(ExpName,'maskC','Dimensions',{'Profile C' numel(lithkC)})

nccreate(ExpName,'lithkD','Dimensions',{'Profile D' numel(lithkD)},'FillValue',nan)
nccreate(ExpName,'sD','Dimensions',{'Profile D' numel(lithkD)})
nccreate(ExpName,'xvelmeanD','Dimensions',{'Profile D' numel(lithkD)},'FillValue',nan)
nccreate(ExpName,'yvelmeanD','Dimensions',{'Profile D' numel(lithkD)},'FillValue',nan)
nccreate(ExpName,'maskD','Dimensions',{'Profile D' numel(lithkD)})

nccreate(ExpName,'lithkE','Dimensions',{'Profile E' numel(lithkE)})
nccreate(ExpName,'sE','Dimensions',{'Profile E' numel(lithkE)})
nccreate(ExpName,'xvelmeanE','Dimensions',{'Profile E' numel(lithkE)},'FillValue',nan)
nccreate(ExpName,'yvelmeanE','Dimensions',{'Profile E' numel(lithkE)},'FillValue',nan)
nccreate(ExpName,'maskE','Dimensions',{'Profile E' numel(lithkE)})

nccreate(ExpName,'lithkF','Dimensions',{'Profile F' numel(lithkF)},'FillValue',nan)
nccreate(ExpName,'sF','Dimensions',{'Profile F' numel(lithkF)})
nccreate(ExpName,'xvelmeanF','Dimensions',{'Profile F' numel(lithkF)},'FillValue',nan)
nccreate(ExpName,'yvelmeanF','Dimensions',{'Profile F' numel(lithkF)},'FillValue',nan)
nccreate(ExpName,'maskF','Dimensions',{'Profile F' numel(lithkF)})

nccreate(ExpName,'lithkG','Dimensions',{'Profile G' numel(lithkG)},'FillValue',nan)
nccreate(ExpName,'sG','Dimensions',{'Profile G' numel(lithkG)})
nccreate(ExpName,'xvelmeanG','Dimensions',{'Profile G' numel(lithkG)},'FillValue',nan)
nccreate(ExpName,'yvelmeanG','Dimensions',{'Profile G' numel(lithkG)},'FillValue',nan)
nccreate(ExpName,'maskG','Dimensions',{'Profile G' numel(lithkG)})

nccreate(ExpName,'lithkH','Dimensions',{'Profile H' numel(lithkH)},'FillValue',nan)
nccreate(ExpName,'sH','Dimensions',{'Profile H' numel(lithkH)})
nccreate(ExpName,'xvelmeanH','Dimensions',{'Profile H' numel(lithkH)},'FillValue',nan)
nccreate(ExpName,'yvelmeanH','Dimensions',{'Profile H' numel(lithkH)},'FillValue',nan)
nccreate(ExpName,'maskH','Dimensions',{'Profile H' numel(lithkH)})
