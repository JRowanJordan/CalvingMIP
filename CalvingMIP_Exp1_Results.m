...
nccreate(ExpName,'Profile_A_VX','Dimensions',{'Profile A' numel(HA)})
nccreate(ExpName,'Profile_A_VY','Dimensions',{'Profile A' numel(HA)})
...
nccreate(ExpName,'Profile_B_VX','Dimensions',{'Profile B' numel(HB)})
nccreate(ExpName,'Profile_B_VY','Dimensions',{'Profile B' numel(HB)})
...
nccreate(ExpName,'Profile_C_VX','Dimensions',{'Profile C' numel(HC)})
nccreate(ExpName,'Profile_C_VY','Dimensions',{'Profile C' numel(HC)})
...
nccreate(ExpName,'Profile_D_VX','Dimensions',{'Profile D' numel(HD)})
nccreate(ExpName,'Profile_D_VY','Dimensions',{'Profile D' numel(HD)})
