...
nccreate(ExpName,'Profile_A_Thickness','Dimensions',{'Profile A' numel(HA)})
nccreate(ExpName,'Profile_A_Distance','Dimensions',{'Profile A' numel(HA)})
...
nccreate(ExpName,'Profile_B_Thickness','Dimensions',{'Profile B' numel(HB)})
nccreate(ExpName,'Profile_B_Distance','Dimensions',{'Profile B' numel(HB)})
...
nccreate(ExpName,'Profile_C_Thickness','Dimensions',{'Profile C' numel(HC)})
nccreate(ExpName,'Profile_C_Distance','Dimensions',{'Profile C' numel(HC)})
...
nccreate(ExpName,'Profile_D_Thickness','Dimensions',{'Profile D' numel(HD)})
nccreate(ExpName,'Profile_D_Distance','Dimensions',{'Profile D' numel(HD)})
...
ncwrite(ExpName,'Profile_A_Thickness',HA)
...
ncwrite(ExpName,'Profile_B_Thickness',HB)
...
ncwrite(ExpName,'Profile_C_Thickness',HC)
...
ncwrite(ExpName,'Profile_D_Thickness',HD)
